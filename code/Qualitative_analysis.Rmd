...
p_afinn <-
  ...
  labs(y = "Affinity score", x = "Student ID")
```

## Top Positive and Negative Words

Most common words matching a positive or negative Bing lexicon sentiment across optional free text responses. Total occurrences are summed across respondents.
